...
import { CheckCheck, MessageCircle, Pin, Users } from "lucide-react";
  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-center gap-1.5">
        ...
        {item.hasRead && (
          <span className="flex items-center gap-1 rounded-full bg-secondary/20 px-2.5 py-1 text-[11px] font-medium text-secondary">
